...
import com.example.jetdevs.fileUploader.controller.BaseController;
...
public class GlobalExceptionHandler extends BaseController {
	...
	public ResponseEntity<ErrorResponse> handleMissingDataException(MissingDataException exception,
			WebRequest webRequest) {
		return error(exception.getMessage(), HttpStatus.BAD_REQUEST, webRequest.getDescription(false));
	}

	@ExceptionHandler(SignatureException.class)
	public ResponseEntity<ErrorResponse> handleSignatureException(AuthenticationException exception,
			WebRequest webRequest) {
